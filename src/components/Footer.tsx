        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4" id="footer-branding">
            ...
            <p className="text-sm text-stone-400 leading-relaxed">
              Semear dignidade, cultivar inclusão, florescer em comunidade. Tecnologia e amor transformando vidas em Franca.
            </p>
          </div>
          ...
          <div className="space-y-4" id="footer-navigation">
            ...
            <ul className="space-y-2 text-sm text-stone-400">
              <li>
                <button onClick={() => setActiveTab('home')} className="hover:text-emerald-400 cursor-pointer transition-colors">
                  Início
                </button>
              </li>
              <li>
                <button onClick={() => setActiveTab('associacao')} className="hover:text-emerald-400 cursor-pointer transition-colors">
                  A Associação
                </button>
              </li>
              <li>
                <button onClick={() => setActiveTab('doacoes')} className="hover:text-emerald-400 cursor-pointer transition-colors">
                  Doações
                </button>
              </li>
              <li>
                <button onClick={() => setActiveTab('projetos')} className="hover:text-emerald-400 cursor-pointer transition-colors">
                  Nossos Projetos
                </button>
              </li>
              <li>
          ...
          <div className="space-y-4" id="footer-contact">
            ...
            <ul className="space-y-3 text-sm text-stone-400">
              ...
              <li className="flex items-center gap-2.5">
                ...
                <a href="tel:16992774601" className="hover:text-emerald-400 transition-colors">
                  (16) 99277-4601
                </a>
              </li>
              <li className="flex items-center gap-2.5">
                <Mail className="h-4 w-4 text-emerald-500 shrink-0" />
                <a href="mailto:casandrissima@gmail.com" className="hover:text-emerald-400 transition-colors">
                  casandrissima@gmail.com
                </a>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4" id="footer-socials">
            <h3 className="text-sm font-semibold tracking-wider text-stone-100 uppercase">Social e Apoio</h3>
            <p className="text-sm text-stone-400">Divida amor nas redes, ajude-nos a ampliar nossa voz!</p>
            
            <div className="card-social-wrapper" id="social-icons-card">
              <a 
              ...
              >
                <svg className="socialSvg instagramSvg" viewBox="0 0 16 16" aria-label="Instagram">
              ...
              <a 
                ...
                title="Twitter / X"
              >
                <svg className="socialSvg twitterSvg" viewBox="0 0 16 16" aria-label="Twitter">
              ...
              <a 
                ...
                title="LinkedIn"
              >
                <svg className="socialSvg linkdinSvg" viewBox="0 0 448 512" aria-label="LinkedIn">
                  <path d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 61.9 111.28 142.3V448z" />
                </svg>
              </a>
              
              <a 
                href="https://wa.me/5516992774601?text=Ol%C3%A1%2C%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20a%20Casa%20Sandr%C3%ADssima" 
                target="_blank" 
                rel="noreferrer"
                ...
                title="WhatsApp"
              >
                <svg className="socialSvg whatsappSvg" viewBox="0 0 16 16" aria-label="WhatsApp">
